    ...
    <section className="flex flex-col space-y-4 sm:space-y-10 ">
      <ContainerWrapper className="relative">
        ...
        <div className="relative">
          ...
          {/* Section header */}
          <div className="max-w-3xl text-left pb-12 md:pb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 " data-aos-id-hero-features>
            <div
              className="p-6 flex flex-col justify-between bg-gray-800 rounded-md min-h-[200px]"
              data-aos="fade-up"
              data-aos-anchor="[data-aos-id-hero-features]"
            >
              <h3 className="h3">
                Startup <br /> development
              </h3>
              <FaArrowRight />
            </div>
            <div
      ...
      <ContainerWrapper className=" relative">
        <div className="relative ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_4fr] gap-4" data-aos="fade-up">
            ...
            <div className="flex flex-col gap-4 w-fit md:col-start-2">
              <p className="text-xl text-white">
                At Craft Studio, we believe in the transformative power of creativity.
              </p>
